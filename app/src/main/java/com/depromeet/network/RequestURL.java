...
public class RequestURL {
    public static final String BASE_URL = "http://3dd7ef56.ngrok.io";
    public static final String LOGIN = "login";
    public static final String CREATE_POEM = "hangshis/create";
    public static final String GET_BY_DATE = "hangshis/get_by_date";
    public static final String GET_BY_LIKE = "hangshis/get_by_like";
